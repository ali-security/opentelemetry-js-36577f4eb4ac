  ...
  describe('utilities', function () {
    ...
    describe('createSslCredentials', function () {
      if (crypto.X509Certificate) {
        // Seal: the repo's checked-in test certs expired 2025-06-08, so this
        // wall-clock assertion fails on any build after that date. Skipped
        // rather than regenerating committed test fixtures; the remaining
        // createSslCredentials tests still exercise the cert files.
